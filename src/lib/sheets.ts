...
const COLUMN_MAP: Record<string, string> = {
  ...
  "name (simplified chinese)": "name_zhHans",
  "name (simplified)": "name_zhHans",
  "organization name (simplified chinese)": "name_zhHans",
  "organization name (simplied chinese)": "name_zhHans",
  "type": "category",
  "category": "category",
  "tags": "tags",
  "price": "price",
